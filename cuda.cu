...
int main(){
    ...
    cudaMemcpy(result,out, sizeof(tPointd)*DIM, cudaMemcpyDeviceToHost);
...
void InPolyhedron( int F,  tPointd * bmin, tPointd * bmax,int radius, tPointd * c_com_V, char * out )
{
